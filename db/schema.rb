...
ActiveRecord::Schema[7.0].define(version: 2023_05_04_193903) do
  ...
  add_foreign_key "cities", "Dogs", column: "dog_id"
  add_foreign_key "cities", "Dogsitters", column: "dogsitter_id"
  add_foreign_key "dogs", "cities"
  add_foreign_key "dogsitters", "cities"
  add_foreign_key "strolls", "Dogs", column: "dog_id"
  add_foreign_key "strolls", "Dogsitters", column: "dogsitter_id"
end
